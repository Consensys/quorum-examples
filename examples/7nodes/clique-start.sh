...
echo "--datadir qdata/dd1 $ARGS --rpcport 22000 --port 21000" | PRIVATE_CONFIG=qdata/c1/tm.ipc xargs nohup geth 2>>qdata/logs/1.log &
echo "--datadir qdata/dd2 $ARGS --rpcport 22001 --port 21001" | PRIVATE_CONFIG=qdata/c2/tm.ipc xargs nohup geth 2>>qdata/logs/2.log &
echo "--datadir qdata/dd3 $ARGS --rpcport 22002 --port 21002" | PRIVATE_CONFIG=qdata/c3/tm.ipc xargs nohup geth 2>>qdata/logs/3.log &
echo "--datadir qdata/dd4 $ARGS --rpcport 22003 --port 21003" | PRIVATE_CONFIG=qdata/c4/tm.ipc xargs nohup geth 2>>qdata/logs/4.log &
echo "--datadir qdata/dd5 $ARGS --rpcport 22004 --port 21004" | PRIVATE_CONFIG=qdata/c5/tm.ipc xargs nohup geth 2>>qdata/logs/5.log &
echo "--datadir qdata/dd6 $ARGS --rpcport 22005 --port 21005" | PRIVATE_CONFIG=qdata/c6/tm.ipc xargs nohup geth 2>>qdata/logs/6.log &
echo "--datadir qdata/dd7 $ARGS --rpcport 22006 --port 21006" | PRIVATE_CONFIG=qdata/c7/tm.ipc xargs nohup geth 2>>qdata/logs/7.log &
set +v
