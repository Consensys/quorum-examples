...
set -v
ARGS="--nodiscover --permissioned --networkid $NETWORK_ID --raft --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,raft,quorumPermission --rpccorsdomain=* --rpcvhosts=* --emitcheckpoints $QUORUM_GETH_ARGS"
